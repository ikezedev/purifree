...
exports.MaybeAsync = exports.MAYBE_ASYNC_URI = void 0;
var Maybe_1 = require("./Maybe");
var EitherAsync_1 = require("./EitherAsync");
var do_1 = require("./pointfree/do");
exports.MAYBE_ASYNC_URI = 'MaybeAsync';
var helpers = {
...
var MaybeAsyncImpl = /** @class */ (function () {
    function MaybeAsyncImpl(runPromise) {
        ...
        this[_a] = exports.MaybeAsync.of;
    }
    MaybeAsyncImpl.prototype[Symbol.iterator] = function () {
    ...
    MaybeAsyncImpl.prototype['fantasy-land/ap'] = function (maybeF) {
    ...
    MaybeAsyncImpl.prototype['fantasy-land/alt'] = function (other) {
    ...
    MaybeAsyncImpl.prototype['fantasy-land/extend'] = function (f) {
    ...
    MaybeAsyncImpl.prototype['fantasy-land/filter'] = function (pred) {
...
exports.MaybeAsync = Object.assign(function (runPromise) { return new MaybeAsyncImpl(runPromise); }, {
    of: function (value) {
        return exports.MaybeAsync.liftMaybe(Maybe_1.Just(value));
    },
