...
exports.EitherAsync = exports.EITHER_ASYNC_URI = void 0;
var Either_1 = require("./Either");
var MaybeAsync_1 = require("./MaybeAsync");
var do_1 = require("./pointfree/do");
exports.EITHER_ASYNC_URI = 'EitherAsync';
var helpers = {
...
var EitherAsyncImpl = /** @class */ (function () {
    function EitherAsyncImpl(runPromise) {
        ...
        this[_a] = exports.EitherAsync.of;
    }
    EitherAsyncImpl.prototype[Symbol.iterator] = function () {
    ...
    EitherAsyncImpl.prototype['fantasy-land/ap'] = function (other) {
    ...
    EitherAsyncImpl.prototype['fantasy-land/alt'] = function (other) {
    ...
    EitherAsyncImpl.prototype['fantasy-land/extend'] = function (f) {
...
exports.EitherAsync = Object.assign(function (runPromise) { return new EitherAsyncImpl(runPromise); }, {
    of: function (value) {
        return exports.EitherAsync.liftEither(Either_1.Right(value));
    },
